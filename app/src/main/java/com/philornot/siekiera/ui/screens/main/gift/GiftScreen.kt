...
/**
 * Ekran prezentu dostępny z szufladki nawigacyjnej.
 * Pozwala na pobranie prezentu nawet po jego pierwszym odebraniu.
 *
...
fun GiftScreen(
    ...
    Column(
        ...
        Text(
            text = if (giftReceived)
                "Kliknij prezent, aby ponownie pobrać plik z eksportem Daylio"
            else
                "Kliknij prezent, aby pobrać plik z eksportem Daylio",
